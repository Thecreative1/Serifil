        ...
        <Reveal>
          <div className="grid gap-16 lg:grid-cols-12 lg:items-end lg:gap-12">
            <div className="lg:col-span-7">
              ...
              <h2 className="mt-8 max-w-[12ch] text-[clamp(2.8rem,6vw,6.5rem)] leading-[0.88] font-bold tracking-[-0.065em] text-text-primary">{copy.title}</h2>
              <p className="mt-10 max-w-[62ch] text-base leading-7 text-text-secondary sm:text-lg">{copy.description}</p>
            </div>
            <div className="border-t border-border lg:col-span-5">
              {copy.principles.map(([number, label]) => (
