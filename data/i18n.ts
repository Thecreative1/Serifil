...
export const translations = {
  pt: {
    ...
    contact: {
      ...
      mapNote: "O mapa interativo é carregado do Google Maps apenas depois deste clique.",
    },
    footer: {
  ...
  en: {
    ...
    contact: {
      ...
      mapNote: "The interactive map is loaded from Google Maps only after you click.",
    },
    footer: {
